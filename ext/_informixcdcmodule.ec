...
EXEC SQL define TABLENAME_LEN      (768 + 255);
...
InformixCdc_extract_record(InformixCdcObject *self, int payload_sz,
                           int packet_scheme, int record_number)
{
    char record_type[17] = "CDC_REC_UNKNOWN";
    PyObject *py_dict = NULL;
